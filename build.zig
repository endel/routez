...
pub fn build(b: *std.Build) void {
    ...
    build_options.addOption(bool, "fault_injection", b.option(bool, "fault-injection", "Test hooks: stall reads of files named *slow-read*; small send buffers for requests naming *small-sndbuf*") orelse false);
